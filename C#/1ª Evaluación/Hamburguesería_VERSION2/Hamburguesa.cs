...
{
    private char tipoFilete; //c = cerdo p = pollo v = vegana//METER VEGANANANAAAAAAA
    ...
    public Hamburguesa(string nombreProducto, char tipoFilete, bool conTomate, bool conQueso, bool conHuevo, bool conCebolla, bool conBacon) : base(nombreProducto)
    {
        ...
        // c = cerdo, p = pollo, v = vegana

        if (tipoFilete == 'c') 
        {
            precioBase = 4.0f;
        }
        else if (tipoFilete == 'p') 
        {
            precioBase = 3.0f;
        }
    ...
    public string ListarIngredientes()
    {
        ...
        if (tipoFilete == 'c')
        {
            ingredientes.Add("Filete de cerdo");
        }
        else if (tipoFilete == 'p')
        {
            ingredientes.Add("Filete de pollo");
        }
        else if (tipoFilete == 'v')
        {
            ingredientes.Add("Filete vegano");
        }
        if (conTomate)
        {
